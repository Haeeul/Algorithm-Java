...
import chap04_2.IntQueue.EmptyIntQueueException;
import chap04_2.IntQueue.OverflowIntQueueException;

public class P_07_IntDeque {
	private int max;
	private int front;
	private int rear;
	private int num;
	...
	public P_07_IntDeque(int capacity) {
		num = front = rear = 0;
		max = capacity;
		try {
			que = new int[max];
